				...
				if (isset($id) != null):
					...
					while ($resdb_cat = $lerdb_cat->returnData()):
						...
						for ($i = 1; $i < $n_cat; $i++):
								...
								$alt_prod_det = 0;
								switch ($$cats) {
									case $sub_cat_1 : $$cat  = $subcat_1;  $$nome  = $nome_1  ;break;
									case $sub_cat_2 : $$cat  = $subcat_2;  $$nome  = $nome_2  ;break;
									case $sub_cat_3 : $$cat  = $subcat_3;  $$nome  = $nome_3  ;break;
									case $sub_cat_4 : $$cat  = $subcat_4;  $$nome  = $nome_4  ;break;
									case $sub_cat_5 : $$cat  = $subcat_5;  $$nome  = $nome_5  ;break;
									case $sub_cat_6 : $$cat  = $subcat_6;  $$nome  = $nome_6  ;break;
									case $sub_cat_7 : $$cat  = $subcat_7;  $$nome  = $nome_7  ;break;
									case $sub_cat_8 : $$cat  = $subcat_8;  $$nome  = $nome_8  ;break;
									case $sub_cat_9 : $$cat  = $subcat_9;  $$nome  = $nome_9  ;break;
									case $sub_cat_10: $$cat  = $subcat_10; $$nome  = $nome_10 ;break;
									case $sub_cat_11: $$cat  = $subcat_11; $$nome  = $nome_11 ;break;
									case $sub_cat_12: $$cat  = $subcat_12; $$nome  = $nome_12 ;break;
									case $sub_cat_13: $$cat  = $subcat_13; $$nome  = $nome_13 ;break;
									case $sub_cat_14: $$cat  = $subcat_14; $$nome  = $nome_14 ;break;
									case $sub_cat_15: $$cat  = $subcat_15; $$nome  = $nome_15 ;break;
									case $sub_cat_16: $$cat  = $subcat_16; $$nome  = $nome_16 ;break;
									case $sub_cat_17: $$cat  = $subcat_17; $$nome  = $nome_17 ;break;
									case $sub_cat_18: $$cat  = $subcat_18; $$nome  = $nome_18 ;break;
									case $sub_cat_19: $$cat  = $subcat_19; $$nome  = $nome_19 ;break;
									case $sub_cat_20: $$cat  = $subcat_20; $$nome  = $nome_20 ;break;
									default: $$cat = $resdb_cat->$cat; $$nome = "selecionar nome"; break;
								}
